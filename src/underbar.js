(function() {
  ...
  _.uniq = function(array, isSorted, iterator) {
    /*
    create result array
    create comparisson array
    iterate over array
      if iterator(i) !present in comparison
        comparison push iterator(i)
        results push i
    return results
    ...
    */
    ...
    if (iterator) {
      _.each(array, function (value) {
        if (_.indexOf(comparisons, iterator(value)) === -1) {
          comparisons.push(iterator(value));
          results.push(value);
        }
      });
    } else {
